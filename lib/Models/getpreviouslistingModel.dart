...
class GetPreviousListingModel {
  bool? status;
  Data? data;

  GetPreviousListingModel({this.status, this.data});

  GetPreviousListingModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
//
//   DataListPrevious.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
//     userId = json['user_id'];
//     title = json['title'];
