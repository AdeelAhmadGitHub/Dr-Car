class GetAllRecentViewModel {
  bool? status;
  List<RecentListing>? recentListing;

  GetAllRecentViewModel({this.status, this.recentListing});

  GetAllRecentViewModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['recent_listing'] != null) {
      recentListing = <RecentListing>[];
      json['recent_listing'].forEach((v) {
        recentListing!.add(new RecentListing.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.recentListing != null) {
      data['recent_listing'] =
          this.recentListing!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class RecentListing {
  ...
  RecentListing.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    title = json['title'];
